...
public class Prac_9 extends Applet implements ItemListener{
    ...
    public void itemStateChanged(ItemEvent e){
        setBackground(((rch.getState() && gch.getState() && bch. getState())  ? Color.white : (rch.getState() && gch.getState()) ? Color.YELLOW : (gch.getState() && bch.getState()) ? Color.CYAN : (rch.getState() && bch.getState()) ? Color.magenta : rch.getState() ? Color.RED : gch.getState() ? Color.GREEN : bch.getState()  ? Color.BLUE : Color.BLACK));
    }
}